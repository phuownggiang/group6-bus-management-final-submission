...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { address: @passenger.address, age: @passenger.age, contact: @passenger.contact, gender: @passenger.gender, name: @passenger.name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { address: @passenger.address, age: @passenger.age, contact: @passenger.contact, gender: @passenger.gender, name: @passenger.name } }
